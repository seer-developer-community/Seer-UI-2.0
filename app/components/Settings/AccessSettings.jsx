...
const autoSelectAPI = "ws://140.143.222.148:9290";
const testnetAPI = settingsAPIs.WS_NODE_LIST.find(a => a.url.indexOf("ws://140.143.222.148:9290") !== -1);
const testnetAPI2 = settingsAPIs.WS_NODE_LIST.find(a => a.url.indexOf("ws://140.143.222.148:9290") !== -1);
