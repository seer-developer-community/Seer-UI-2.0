...
class Exchange extends React.Component {
    ...
    _initialState(props) {
        ...
        return {
            ...
            currentPeriod: "all"// 3600 * 24 * 3 // 1 w
        };
    }
    ...
    componentWillMount() {
        if (Apis.instance().chain_id.substr(0, 8)=== "cea4fdf4") {
    ...
    isMarketFrozen() {
        ...
        if (quoteWhiteList.length==0 || baseWhiteList.length==0) {
            return {isFrozen: false};
        }
        if (baseWhiteList.indexOf(quoteAsset.get("id")) != -1 ||
