      ...
      <div ref="transactionConfirm">
        <BaseModal id="transaction_confirm_modal" ref="modal" overlay={true} overlayClose={!broadcasting} noCloseBtn={true}>
          <div style={{minHeight: 350}} className="grid-block vertical no-padding no-margin">
            ...
            {this.props.propose ?
              <div className="grid-content full-width-content form-group" style={{paddingTop: "1rem"}}>
            ...
            <div className="grid-block shrink" style={{paddingTop: "2rem"}}>
              {button_group}

              {/* P R O P O S E   T O G G L E */}
              { !this.props.transaction.has_proposed_operation() && !(broadcast || broadcasting) ?
                <div className="align-right flex-align-middle" style={{alignItems: "flex-start",marginTop:5}}>
