...
import {OrderRow, TableHeader} from "../Exchange/MyOpenOrdersSimple";
    ...
    render() {
            ...
            if (base && quote) {
                ...
                marketOrders[marketID].push(
                    <OrderRow
                        ...
                        onCheckCancel={this._cancelLimitOrder.bind(this, order.id)}
                    />
                );
            }
        });
        ...
        return (
            <div className="grid-content no-overflow no-padding" style={{paddingBottom: 15}}>
                ...
                <table className="table table-striped dashboard-table close-border table-hover"  style={{marginTop:"34px"}}>
                  <thead>
                  <tr>
                    <th colSpan="5" className="dashboard-table-title">
                      <div style={{display:"flex",flexDirection:"row",justifyContent:"space-between",alignContent:"center"}}>
                        <Translate component="span" content="account.open_orders" />
                        {this.props.children}
                      </div>
                    </th>
                  </tr>
                  </thead>
                  <TableHeader settings={this.props.settings} isMyAccount={this.props.isMyAccount}/>
                    {tables}
